...
NS_LOG_COMPONENT_DEFINE ("v2v25_cb1");
...
//2
 ...
 /* Ptr<Node> appSource3 = NodeList::GetNode (47);
  ...
  ApplicationContainer apps2 = source2.Install (nodes.Get  (47));
...
//4
 ...
 // source3.SetAttribute ("PacketSize", UintegerValue (1000));
  ApplicationContainer apps3 = source3.Install (nodes.Get  (40));
...
//5 
  ...
  ApplicationContainer apps4 = source4.Install (nodes.Get  (88));
...
//6
  ...
  ApplicationContainer apps5 = source5.Install (nodes.Get  (70));
...
//7
  ...
  ApplicationContainer apps6 = source6.Install (nodes.Get  (55));
...
//8
  ...
  ApplicationContainer apps7 = source7.Install (nodes.Get  (24));
...
// Enabling the XML Flow Monitor
 if (enableFlowMonitor)
    {
      flowmonHelper.SerializeToXmlFile ("v2v25_cb1.flowmon", false, false);
    }
  Simulator::Destroy ();
  return 0;
}
